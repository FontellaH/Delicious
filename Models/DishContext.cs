...
using Microsoft.EntityFrameworkCore;
 namespace Delicious.Models;  // ********* #1 its not yourprojectname... change to Pet or your model class name **************
...
{   
    ...
    public DbSet<Dish> Dishs { get; set; } //********* #2 Change from Monster to <Pet> model file... i will name my table for sql Pets
